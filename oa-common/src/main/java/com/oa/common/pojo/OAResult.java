...
//    }
    ...
    /**
     * 将json结果集转化为OAResult对象
     * 
     * @param jsonData json数据
     * @param clazz OAResult中的object类型
     * @return
     */
    public static OAResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, OAResult.class);
            }
     ...
     * @return
     */
    public static OAResult format(String json) {
        try {
            return MAPPER.readValue(json, OAResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static OAResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
