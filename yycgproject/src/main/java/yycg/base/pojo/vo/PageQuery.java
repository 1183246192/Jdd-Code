...
public class PageQuery {
    ...
    //mysql用的查询分页
//    private int PageQuery_mysql = PageQuery_end - PageQuery_start;
	...
	public void setPageParams(int infoCount, int pageSize, int currPage) {
		...
		this.PageQuery_end = this.PageQuery_pageSize;
	}
...
/*	public int getPageQuery_mysql() {
		return PageQuery_mysql;
	}

	public void setPageQuery_mysql(int pageQuery_mysql) {
		PageQuery_mysql = pageQuery_mysql;
	}
*/
