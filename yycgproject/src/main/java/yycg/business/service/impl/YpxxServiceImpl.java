...
public class YpxxServiceImpl implements YpxxService {
	...
	@Override
	public int findSysuserCount(YpxxQueryVo ypxxQueryVo) throws Exception{
		return ypxxMapperCustom.findYpxxCount(ypxxQueryVo);
	}

	@Override
	public List<YpxxCustom> exportList(YpxxQueryVo ypxxQueryVo)
			throws Exception {
		return ypxxMapperCustom.exportList(ypxxQueryVo);
	}
}
