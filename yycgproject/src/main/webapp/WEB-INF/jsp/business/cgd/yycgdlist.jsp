			...
			<TABLE  class="table_search">
				<TBODY>
					<TR>
						...
						<td >
						 <INPUT id="yycgdCustom.cjtime_start" name="yycgdCustom.cjtime_start" editable=false
						 		class="easyui-datebox" style="width:100px"/>--
					     <INPUT id="yycgdCustom.cjtime_end" name="yycgdCustom.cjtime_end" editable=false
							 class="easyui-datebox" style="width:100px"/>
