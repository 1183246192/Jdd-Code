			...
			<TABLE  class="table_search">
				<TBODY>
					<TR>
						...
						<td >
						<INPUT id="yycgdCustoms.cjtime_start" type="text" class="easyui-datebox" style="width:120px"/>--
					    <INPUT id="yycgdCustoms.cjtime_end" type="text" class="easyui-datebox" style="width:120px"/>
