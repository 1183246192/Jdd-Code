 ...
 var gysypmladd = function(){
	...
	//执行添加函数
	  function(){
		...
		//alert("indexs的值:"+indexs+",rows的值："+rows+"处理之后的值:"+indexs.join(","));
...
var columns = [ [{
	...
	field : 'id',
	hidden:true,
	formatter:function(value, row, index){//index是每行的序号,ypxxCustoms是action中接收的list集合对象名称，ypxxid是list中对象的属性名
