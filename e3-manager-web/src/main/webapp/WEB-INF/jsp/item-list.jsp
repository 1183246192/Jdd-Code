...
<form id="itemqueryForm">
<TABLE class="table_search">
		<TBODY>
			<TR>
				<TD class="td_left">商品标题：</td>
				<td class="td_right"><INPUT type="text" name="ItemCustom.protitle" /></TD>
				<TD class="td_left">卖点：</TD>
				<td class="td_right"><INPUT type="text" name="ItemCustom.propoint" /></TD>
				<TD class="td_left">价格区间：</TD>
				<td class="td_right_input"><INPUT type="text" name="ItemCustom.proprice1" /><span>&nbsp;-&nbsp;</span><INPUT type="text" name="ItemCustom.proprice2" /></TD>
				<td ><a id="btn" href="#" onclick="queryItem()"
					class="easyui-linkbutton td_btn" iconCls='icon-search'>查询</a></td>
			</TR>
		</TBODY>
	</TABLE>
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'title',width:350">商品标题</th>
...
<script>
	...
	function queryItem(){
		...
		var formdata = $("#itemqueryForm").serializeJson();
