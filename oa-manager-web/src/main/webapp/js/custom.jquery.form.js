...
var imageUrl= window.location.protocol + '//' + window.location.host + '/'; 
...
function loading(){
	$("body").append('<div  id="load" style="width:100%;position:absolute;top:250px;text-align:center;"><img src="'+imageUrl+'images/loading2.gif" /></div>');
}
