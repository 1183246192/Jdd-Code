...
//			url : '${baseurl}menu.json',
	...
	function updatepwd() {
		...
		createmodalwindow("修改密码", 500, 290, '${baseurl}update/pwd');
	}
...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no" >
	<DIV
		...
		<SPAN style="padding-right: 20px; float: right;" class="head">
			...
			<A href="#">使用帮助</A>
			&nbsp;&nbsp;
<!--			<A title='修改密码' ref='modifypwd' href="#" rel='${baseurl}update/pwd' icon='icon-null' id="modifypwd">修改密码</A> -->
 			<A title='修改密码' href="javascript:updatepwd()" >修改密码</A>
			&nbsp;&nbsp;
			<A id="loginOut" href=javascript:logout()>退出系统</A>

		</SPAN> <SPAN style="padding-left: 10px; font-size: 16px;"><IMG
			align="absmiddle" src="../../images/blocks.gif" width="20" height="20">
			这是一个测试系统</SPAN> <SPAN style="padding-left: 15px;" id="News"></SPAN>
	</DIV>
